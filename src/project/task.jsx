  ...
  return (
    <>
      {/* <div className="space-y-6">
        <div className='bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-6 shadow-sm'>
          <div className='flex flex-wrap justify-between items-center'>
            <div className='flex h-fit gap-4'>
              <button
                type="button"
                className='px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl flex items-center gap-2 hover:from-indigo-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105'
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-3 w-64 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 bg-white shadow-sm"
                />
              </div>
            </div>
            <div className='flex gap-2'>
              <button type="button" className='px-4 py-2 bg-white border-2 border-indigo-200 rounded-lg text-indigo-700 font-medium hover:bg-indigo-50 transition-colors'>All</button>
              <button type="button" className='px-4 py-2 bg-white border-2 border-indigo-200 rounded-lg text-indigo-700 font-medium hover:bg-indigo-50 transition-colors'>Active</button>
              <button type="button" className='px-4 py-2 bg-white border-2 border-indigo-200 rounded-lg text-indigo-700 font-medium hover:bg-indigo-50 transition-colors'>Completed</button>
            </div>
          </div>
        </div> */}
      <div className="space-y-6">
